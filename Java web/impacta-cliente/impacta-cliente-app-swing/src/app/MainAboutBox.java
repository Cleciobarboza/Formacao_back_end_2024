...
public class MainAboutBox extends javax.swing.JDialog {
    ...
    private static final long serialVersionUID = 565634229052754565L;
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(app.ImpactaSwing.class).getContext().getResourceMap(MainAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(app.ImpactaSwing.class).getContext().getActionMap(MainAboutBox.class, this);
